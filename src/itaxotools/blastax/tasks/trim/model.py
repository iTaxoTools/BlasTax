...
class Model(BlastTaskModel):
    ...
    option_trim_stop = Property(bool, False)
    option_trim_end = Property(bool, False)
    option_discard_ambiguous = Property(bool, False)
    ...
    def start(self):
        ...
        self.exec(
            ...
            trim_stop=self.option_trim_stop,
            trim_end=self.option_trim_end,
            discard_ambiguous=self.option_discard_ambiguous,
