...
task_pixmaps_large = LazyResourceCollection(
    ...
    decont2=lambda: VectorPixmap(get_data("graphics/decont2.svg"), Size.Large.size),
    taxo=lambda: VectorPixmap(get_data("graphics/taxo.svg"), Size.Large.size),
    export=lambda: VectorPixmap(get_data("graphics/export.svg"), Size.Large.size),
    ...
    download=lambda: VectorPixmap(get_data("graphics/download.svg"), Size.Large.size),
)
...
task_pixmaps_medium = LazyResourceCollection(
    ...
    decont2=lambda: VectorPixmap(get_data("graphics/decont2.svg"), Size.Medium.size),
    taxo=lambda: VectorPixmap(get_data("graphics/taxo.svg"), Size.Medium.size),
    export=lambda: VectorPixmap(get_data("graphics/export.svg"), Size.Medium.size),
    ...
    download=lambda: VectorPixmap(get_data("graphics/download.svg"), Size.Medium.size),
)
